      ...
      <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav" class="pt-4">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="relatorioofertas.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Relatório de ofertas</span></a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="relatoriodedizimistas.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Relatório de dizimistas</span></a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="relatoriodeofertas.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Relatório de ofertas nos cultos</span></a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="relatoriodespesas.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Relatório de despesas</span></a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="relatoriogeral.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Relatório geral</span></a>
            </li>
            <!---->
          </ul>
        </nav>
